...
export default function NotFound(): JSX.Element {
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[var(--surface-base)] px-6 text-[var(--text-primary)]">
      ...
      <div className="glass-panel relative z-10 max-w-xl rounded-[2rem] px-8 py-10 text-center">
        ...
        <p className="mt-4 text-sm leading-7 text-[var(--text-secondary)]">
          The requested page is not part of this spatial review workspace.
        </p>
        <Link
          href="/"
          className="focus-ring mt-7 inline-flex items-center rounded-full border border-white/10 bg-white/[0.08] px-5 py-3 text-sm font-medium text-white transition-all duration-300 ease-out hover:scale-[1.02] hover:border-[#8ea8ff]/28 hover:bg-white/[0.12]"
        >
          Return home
        </Link>
      </div>
